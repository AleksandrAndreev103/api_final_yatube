...
<ul>
 ...
 <li>
   ...
   <ul>
     <li><a href="#Получение-публикаций">Получение публикаций (GET)</a></li>
     <li><a href="#Зарегистрироваться">Зарегистрироваться на сайте</a></li>
     <li><a href="#Получить-JWT-токен">Получить токен</a></li>
     <li><a href="#Создание-публикации">Создание публикации</a></li>
     <li><a href="#Добавление-комментария">Добавление комментария</a></li>
  </ul>
 </li>
